...
public class RestServiceController extends AbstractRestService {
	...
	public ResponseEntity<?> createGasto(@RequestBody CabeceraGasto cabeceraGasto) {
		...
		logger.debug("RestServiceController - createGasto: Iniciando...");
		...
		logger.debug("RestServiceController - createGasto: Finalizado ");
	...
	public ResponseEntity<?> updateGasto(@PathVariable("id") long id, @RequestBody CabeceraGasto gasto) {
		...
		logger.debug("RestServiceController - updateGasto: Iniciando...");
		...
		logger.debug("RestServiceController - updateGasto: Finalizando...");
	...
	public ResponseEntity<?> deleteGasto(@PathVariable("id") Long id) {
		...
		try {
			...
			logger.error("RestServiceController - deleteGasto: No se pudo crear la cabecera gasto...", e);
		...
		logger.debug("RestServiceController - deleteGasto: Finalizando...");
	...
	@RequestMapping("/getDetallesGasto/{id}") // GET
	public ResponseEntity<?> getDetallesGasto(@PathVariable("id") long id) {
	...
	public ResponseEntity<?> deleteDetallesGasto(@RequestBody List<DetalleGasto> detalles) {
		...
		Message message = new Message(1, "Detalles de gastos eliminados");
