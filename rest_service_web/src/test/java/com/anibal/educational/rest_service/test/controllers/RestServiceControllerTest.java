...
public class RestServiceControllerTest extends AbstractRestService {
	...
	@RequestMapping("/listLibrosTest") //GET
...
//		}
    ...
    @RequestMapping(value = "/libroTest", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/libroTest/{id}",method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/libroTest/{id}", method = RequestMethod.DELETE)
