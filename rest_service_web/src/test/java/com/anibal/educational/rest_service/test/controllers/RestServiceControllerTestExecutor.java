...
public class RestServiceControllerTestExecutor {
    ...
    public static void oneTimeSetUp() {
    	...
    	System.out.println("\n"+RestServiceControllerTestExecutor.class.getName()+" Iniciando el servicio para probar metodos rest");
	...
	public void listLibrosTest(){
		...
		String url = REST_SERVICE_URI+"/listLibrosTest";
		...
		try {
			...
			List<?> libros = restTemplate.getForObject(url, List.class);
